...
import { Mail, ArrowLeft, Key, Lock, Shield, CheckCircle, AlertCircle, Eye, EyeOff, Clock } from 'lucide-react';
      ...
      <main className="forgot-password-main">
        <div className="forgot-password-container">
          ...
          <div className="page-header">
            ...
            <p className="page-subtitle">Reset your password to regain access to your account</p>
          </div>
